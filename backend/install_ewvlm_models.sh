...
echo -e "${BLUE}=======================================================================${NC}"
echo -e "${BLUE}   ewVLM-Core - Ollama 로컬 공공보안 모델 자동 다운로드 및 검증       ${NC}"
echo -e "${BLUE}=======================================================================${NC}"
...
MODELS=("llama3.2-vision" "solar" "paligemma2")
