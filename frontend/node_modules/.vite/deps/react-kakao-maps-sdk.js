...
// node_modules/react-kakao-maps-sdk/esm/_virtual/index.js
var shim = { exports: {} };

// node_modules/react-kakao-maps-sdk/esm/node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.4/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js
var import_react5 = __toESM(require_react(), 1);

// node_modules/react-kakao-maps-sdk/esm/_virtual/use-sync-external-store-shim.development.js
var useSyncExternalStoreShim_development = {};

// node_modules/react-kakao-maps-sdk/esm/node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.4/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js
...
function requireUseSyncExternalStoreShim_development() {
  ...
  (function() {
    ...
    var React$1 = import_react6.default, objectIs = "function" === typeof Object.is ? Object.is : is, useState5 = React$1.useState, useEffect3 = React$1.useEffect, useLayoutEffect18 = React$1.useLayoutEffect, useDebugValue = React$1.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim2 = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
// node_modules/react-kakao-maps-sdk/esm/node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.4/node_modules/use-sync-external-store/shim/index.js
if (false) {
...
// node_modules/react-kakao-maps-sdk/esm/components/MarkerClusterer.store.js
var createMarkerClustererRedrawVersionStore = () => {
  let version = 0;
...
var KakaoMapMarkerClustererContext = import_react7.default.createContext(null);
var MarkerClusterer = import_react7.default.forwardRef(function MarkerClusterer2(_ref, ref) {
  let {
    onClusterclick,
    onClusterdblclick,
    onClustered,
  ...
  const redrawVersionStore = (0, import_react7.useMemo)(() => createMarkerClustererRedrawVersionStore(), []);
  const markerClusterer = (0, import_react7.useMemo)(() => {
  ...
  const contextValue = (0, import_react7.useMemo)(() => ({
    addMarker: (marker) => {
      markerClusterer == null ? void 0 : markerClusterer.addMarker(marker, true);
      redrawVersionStore.requestRedraw();
    },
    removeMarker: (marker) => {
      markerClusterer == null ? void 0 : markerClusterer.removeMarker(marker, true);
      redrawVersionStore.requestRedraw();
    }
  }), [markerClusterer, redrawVersionStore]);
  (0, import_react7.useImperativeHandle)(ref, () => markerClusterer, [markerClusterer]);
...
var Marker = import_react8.default.forwardRef(function Marker2(_ref, ref) {
  let {
    map,
    position,
    children,
  ...
  const markerCluster = (0, import_react8.useContext)(KakaoMapMarkerClustererContext);
  const markerImage = (0, import_react8.useMemo)(() => {
  ...
  (0, import_react8.useImperativeHandle)(ref, () => marker, [marker]);
...
var MapMarker = import_react9.default.forwardRef(function MapMarker2(_ref, ref) {
  let {
    position,
    ...args
  } = _ref;
  const map = useMap(`MapMarker`);
  const markerPosition = (0, import_react9.useMemo)(() => {
    if ("lat" in position) {
...
var MapInfoWindow = import_react10.default.forwardRef(function MapInfoWindow2(_ref, ref) {
  let {
    position,
    children,
    disableAutoPan,
  ...
  const infoPosition = (0, import_react10.useMemo)(() => {
    return new kakao.maps.LatLng(position.lat, position.lng);
...
var CustomOverlayMap = import_react11.default.forwardRef(function CustomOverlayMap2(_ref, ref) {
  let {
    position,
    children,
    clickable,
  ...
  const markerCluster = (0, import_react11.useContext)(KakaoMapMarkerClustererContext);
  const overlayPosition = (0, import_react11.useMemo)(() => {
    return new kakao.maps.LatLng(position.lat, position.lng);
  }, [position.lat, position.lng]);
  const overlay = (0, import_react11.useMemo)(() => {
    const container2 = document.createElement("div");
    container2.style.display = "none";
  ...
  const container = (0, import_react11.useMemo)(() => overlay.getContent(), [overlay]);
  (0, import_react11.useImperativeHandle)(ref, () => overlay, [overlay]);
...
var MapTypeControl = import_react12.default.forwardRef(function MapTypeControl2(_ref, ref) {
  let {
  ...
  const mapTypeControl = (0, import_react12.useMemo)(() => {
    return new kakao.maps.MapTypeControl();
  }, []);
  (0, import_react12.useImperativeHandle)(ref, () => mapTypeControl, [mapTypeControl]);
...
var ZoomControl = import_react13.default.forwardRef(function ZoomControl2(_ref, ref) {
  let {
    position: _position = kakao.maps.ControlPosition.RIGHT
  } = _ref;
  const map = useMap(`ZoomControl`);
  const position = typeof _position === "string" ? kakao.maps.ControlPosition[_position] : _position;
  const ZoomControl3 = (0, import_react13.useMemo)(() => {
    return new kakao.maps.ZoomControl();
  }, []);
  (0, import_react13.useImperativeHandle)(ref, () => ZoomControl3, [ZoomControl3]);
...
var Circle = import_react15.default.forwardRef(function Circle2(_ref, ref) {
  let {
    center,
    radius,
    fillColor,
  ...
  const circleCenter = (0, import_react15.useMemo)(() => {
    return new kakao.maps.LatLng(center.lat, center.lng);
  }, [center.lat, center.lng]);
  const circle = (0, import_react15.useMemo)(() => {
  ...
  (0, import_react15.useImperativeHandle)(ref, () => circle, [circle]);
...
var Polyline = import_react16.default.forwardRef(function Polyline2(_ref, ref) {
  let {
    path,
    endArrow,
    onClick,
  ...
  const polyLinePath = (0, import_react16.useMemo)(() => {
  ...
  const polyline = (0, import_react16.useMemo)(() => {
  ...
  (0, import_react16.useImperativeHandle)(ref, () => polyline, [polyline]);
...
var Polygon = import_react17.default.forwardRef(function Polygon2(_ref, ref) {
  let {
    path,
    onClick,
    onMousedown,
  ...
  const polygonPath = (0, import_react17.useMemo)(() => {
    if (path.every((v) => v instanceof Array)) {
      return path.map((v) => {
        return v.map((p) => new kakao.maps.LatLng(p.lat, p.lng));
      });
  ...
  const polygon = (0, import_react17.useMemo)(() => {
  ...
  (0, import_react17.useImperativeHandle)(ref, () => polygon, [polygon]);
...
var Rectangle = import_react18.default.forwardRef(function Rectangle2(_ref, ref) {
  let {
    bounds,
    onClick,
    onMousedown,
  ...
  const rectangleBounds = (0, import_react18.useMemo)(() => {
  ...
  const rectangle = (0, import_react18.useMemo)(() => {
  ...
  (0, import_react18.useImperativeHandle)(ref, () => rectangle, [rectangle]);
...
var Ellipse = import_react19.default.forwardRef(function Ellipse2(_ref, ref) {
  let {
    center,
    rx,
    ry,
  ...
  const ellipseCenter = (0, import_react19.useMemo)(() => {
    return new kakao.maps.LatLng(center.lat, center.lng);
  }, [center.lat, center.lng]);
  const ellipse = (0, import_react19.useMemo)(() => {
  ...
  (0, import_react19.useImperativeHandle)(ref, () => ellipse, [ellipse]);
...
var AbstractOverlay = import_react20.default.forwardRef(function AbstractOverlay2(_ref, ref) {
  let {
    draw,
    onAdd,
    onRemove,
  ...
  const map = useMap();
  const reactAbstractOverlay = (0, import_react20.useMemo)(() => {
  ...
  (0, import_react20.useImperativeHandle)(ref, () => reactAbstractOverlay, [reactAbstractOverlay]);
...
var KakaoRoadviewContext = import_react21.default.createContext(void 0);
var Roadview = import_react21.default.forwardRef(function Roadview2(_ref, ref) {
  let {
    id,
    as,
    children,
  ...
  const [roadview, setRoadview] = (0, import_react21.useState)();
  ...
  (0, import_react21.useImperativeHandle)(ref, () => roadview, [roadview]);
  useIsomorphicLayoutEffect(() => {
...
var useRoadview = (componentName) => {
  const kakaoRoadview = (0, import_react22.useContext)(KakaoRoadviewContext);
  if (!kakaoRoadview) {
...
// node_modules/react-kakao-maps-sdk/esm/components/CustomOverlayRoadview.js
var CustomOverlayRoadview = import_react23.default.forwardRef(function CustomOverlayRoadview2(_ref, ref) {
  let {
    position,
    children,
    clickable,
  ...
  const overlayPosition = (0, import_react23.useMemo)(() => {
    if ("lat" in position) {
      return new kakao.maps.LatLng(position.lat, position.lng);
    }
  ...
  const overlay = (0, import_react23.useMemo)(() => {
    const container2 = document.createElement("div");
    container2.style.display = "none";
    const KakaoCustomOverlay = new kakao.maps.CustomOverlay({
      clickable,
  ...
  const container = (0, import_react23.useMemo)(() => overlay.getContent(), [overlay]);
  (0, import_react23.useImperativeHandle)(ref, () => overlay, [overlay]);
...
var RoadviewMarker = import_react24.default.forwardRef(function RoadviewMarker2(_ref, ref) {
  let {
    position,
    ...args
  } = _ref;
  const roadview = useRoadview(`RoadviewMarker`);
  const markerPosition = (0, import_react24.useMemo)(() => {
    if ("lat" in position) {
      return new kakao.maps.LatLng(position.lat, position.lng);
    }
    if ("x" in position) {
...
var RoadviewInfoWindow = import_react25.default.forwardRef(function RoadviewInfoWindow2(_ref, ref) {
  let {
    position,
    children,
    altitude,
  ...
  const infoPosition = (0, import_react25.useMemo)(() => {
    if ("lat" in position) {
      return new kakao.maps.LatLng(position.lat, position.lng);
    }
    return new kakao.maps.Viewpoint(position.pan, position.tilt, position.zoom, position.panoId);
...
var DrawingManagerContext = import_react26.default.createContext(void 0);
...
var DrawingManager = import_react26.default.forwardRef(function DrawingManager2(_ref, ref) {
  let {
    arrowOptions,
    circleOptions,
    ellipseOptions,
  ...
  const drawingManager = (0, import_react26.useMemo)(
    () => {
  ...
  (0, import_react26.useImperativeHandle)(ref, () => drawingManager, [drawingManager]);
  (0, import_react26.useLayoutEffect)(() => {
...
var Toolbox = import_react27.default.forwardRef(function Toolbox2(_ref, ref) {
  let {
    position: _position = kakao.maps.ControlPosition.TOP
  } = _ref;
  const position = typeof _position === "string" ? kakao.maps.ControlPosition[_position] : _position;
  const map = useMap("Toolbox");
  const drawingmanager = (0, import_react27.useContext)(DrawingManagerContext);
  if (!drawingmanager) {
    throw new Error("Toolbox must exist inside DrawingManager Component!`");
  }
  const toolbox = (0, import_react27.useMemo)(() => new kakao.maps.drawing.Toolbox({
    drawingManager: drawingmanager
  }), [drawingmanager]);
  (0, import_react27.useImperativeHandle)(ref, () => toolbox, [toolbox]);
...
var StaticMap = import_react28.default.forwardRef(function StaticMap2(_ref, ref) {
  let {
    as,
    id,
    center,
  ...
  const [map, setMap] = (0, import_react28.useState)();
  ...
  (0, import_react28.useImperativeHandle)(ref, () => map, [map]);
  useIsomorphicLayoutEffect(() => {
...
var useKakaoLoader = (options) => {
  const [state, setState] = (0, import_react29.useState)([true, void 0]);
